...
import com.guangnian.mvvm.util.UrlEncoderUtils.Companion.hasUrlEncoded
import com.guangnian.mvvm.util.ZipHelper.Companion.decompressForGzip
import com.guangnian.mvvm.util.ZipHelper.Companion.decompressToStringForZlib
import okhttp3.*
import okio.Buffer
    ...
    companion object {
        ...
        fun isForm(mediaType: MediaType?): Boolean {
            return if (mediaType?.subtype == null) {
                ...
                // 使用新的 lowercase() API
                mediaType.subtype.lowercase(Locale.getDefault())
