package com.guangnian.mvvm.ext.download
...
object FileTool {
    ...
    fun getBasePath(): String {
        var p: String? = com.guangnian.mvvm.base.appContext.getExternalFilesDir(null)?.path
        val f: File? = com.guangnian.mvvm.base.appContext.getExternalFilesDir(null)
        if (null != f) {
            p = f.absolutePath
        }
        return p ?: ""
